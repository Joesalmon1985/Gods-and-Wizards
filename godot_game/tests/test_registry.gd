...
static func all_modules() -> Array:
	return [
		...
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractBreach", "module": TestRuleContractBreach},
		{"category": CATEGORY_INTEGRATION, "name": "TestBreachCascadeContract", "module": TestBreachCascadeContract},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractHeroMovement", "module": TestRuleContractHeroMovement},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractInfection", "module": TestRuleContractInfection},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractInfectionSurge", "module": TestRuleContractInfectionSurge},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractHeroStacking", "module": TestRuleContractHeroStacking},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractOccupiedDevelopment", "module": TestRuleContractOccupiedDevelopment},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractProductionTiming", "module": TestRuleContractProductionTiming},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractTrading", "module": TestRuleContractTrading},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractUiBoundary", "module": TestRuleContractUiBoundary},
		{"category": CATEGORY_INTEGRATION, "name": "TestRuleContractExport", "module": TestRuleContractExport},
		{"category": CATEGORY_INTEGRATION, "name": "TestDevelopmentBuild", "module": TestDevelopmentBuild},
		{"category": CATEGORY_INTEGRATION, "name": "TestDevelopmentEffectEngine", "module": TestDevelopmentEffectEngine},
		{"category": CATEGORY_INTEGRATION, "name": "TestDevelopmentEffectFidelity", "module": TestDevelopmentEffectFidelity},
		...
		{"category": CATEGORY_ARCHITECTURE, "name": "TestStrategicDraftViewModel", "module": TestStrategicDraftViewModel},
		{"category": CATEGORY_ARCHITECTURE, "name": "TestStrategicDevelopmentViewModel", "module": TestStrategicDevelopmentViewModel},
		{"category": CATEGORY_ARCHITECTURE, "name": "TestStrategicCardDisplay", "module": TestStrategicCardDisplay},
		{"category": CATEGORY_UNIT, "name": "TestWizardWorldInput", "module": TestWizardWorldInput},
		{"category": CATEGORY_UNIT, "name": "TestWizardMovementInput", "module": TestWizardMovementInput},
		{"category": CATEGORY_UNIT, "name": "TestWizardCameraRig", "module": TestWizardCameraRig},
		{"category": CATEGORY_UNIT, "name": "TestWorldPresentationScale", "module": TestWorldPresentationScale},
		{"category": CATEGORY_UNIT, "name": "TestBillboardManifest", "module": TestBillboardManifest},
		{"category": CATEGORY_ARCHITECTURE, "name": "TestBuiltDevelopmentDisplay", "module": TestBuiltDevelopmentDisplay},
		{"category": CATEGORY_UNIT, "name": "TestEncounterProximity", "module": TestEncounterProximity},
		{"category": CATEGORY_ARCHITECTURE, "name": "TestWizardWorldController", "module": TestWizardWorldController},
		{"category": CATEGORY_INTEGRATION, "name": "TestEncounterSessionRules", "module": TestEncounterSessionRules},
		{"category": CATEGORY_INTEGRATION, "name": "TestSpellEncounterBridge", "module": TestSpellEncounterBridge},
		{"category": CATEGORY_UNIT, "name": "TestTinyPolicy", "module": TestTinyPolicy},
		{"category": CATEGORY_UNIT, "name": "TestTinyNeuralNetwork", "module": TestTinyNeuralNetwork},
		{"category": CATEGORY_INTEGRATION, "name": "TestMacroRlTrainer", "module": TestMacroRlTrainer},
		{"category": CATEGORY_INTEGRATION, "name": "TestMacroNeuralTrainer", "module": TestMacroNeuralTrainer},
		{"category": CATEGORY_INTEGRATION, "name": "TestMicroNeuralTrainer", "module": TestMicroNeuralTrainer},
		{"category": CATEGORY_INTEGRATION, "name": "TestTrainingEvaluationHarness", "module": TestTrainingEvaluationHarness},
		...
		{"category": CATEGORY_INTEGRATION, "name": "TestSpellEffectFidelity", "module": TestSpellEffectFidelity},
