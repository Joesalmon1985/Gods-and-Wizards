...
@export var body_size: Vector3 = Vector3(6, 6, 6)  # house body
@export var roof_height: float = 10.5              # cone height
...
@export var spawn_jitter_radius: float = 4.0
...
var spawn_interval_sec: float = 2        # spawn_interval
var audit_interval_sec: float = 3         # audit_interval
var min_population: int = 3             # min_pop
var max_population: int = 7             # max_pop
